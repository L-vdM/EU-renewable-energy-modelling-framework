...
def set_hydro_attributes(ds):
    a = {
        ...
        'conventional': ['conventional energy production', 'production not by renewable sources'],
        'diff_dev': ['deviation difference', 'difference of relative mean deviation between demand and hydro production']
...
def update_energy_attributes(energy_production, energy_type, unit, eur=False, potential=False):
    """
